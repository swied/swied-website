...
description: 'Get financial reporting trends for any XBRL tag, by stock ticker, from the data.sec.gov API'
author: Scott Wied
date: 11/06/2022
categories:
  - Pandas
